package com.teamantigravity.gravityinstaller.presentation.install.controller
...
import com.teamantigravity.gravityinstaller.privileged.IPrivilegedService
import com.teamantigravity.gravityinstaller.privileged.PrivilegedRootService
...
class FullInstallerBackendFactory : InstallerBackendFactory {
    ...
    override suspend fun installTargeted(
        ...
        runCatching {
            val targetedInstaller = com.teamantigravity.gravityinstaller.util.HiddenApiHacks.createPackageInstallerForUser(
            ...
            targetedInstaller.openSession(sessionId).use { session ->
                ...
                val intent = android.content.Intent("com.teamantigravity.gravityinstaller.INSTALL_STATUS").apply {
