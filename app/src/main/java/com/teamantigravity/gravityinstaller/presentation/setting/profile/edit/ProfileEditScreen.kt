...
private fun ProfileEditUi(
    ...
    rootState: com.teamantigravity.gravityinstaller.presentation.install.controller.RootState,
        ...
        LazyColumn(
            ...
            item {
                SettingsSection(
                    ...
                    val rootSelectable = rootState == com.teamantigravity.gravityinstaller.presentation.install.controller.RootState.READY ||
                        rootState == com.teamantigravity.gravityinstaller.presentation.install.controller.RootState.DENIED ||
                        rootState == com.teamantigravity.gravityinstaller.presentation.install.controller.RootState.UNKNOWN
