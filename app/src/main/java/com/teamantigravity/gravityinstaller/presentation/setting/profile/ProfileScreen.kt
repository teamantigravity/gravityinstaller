    ...
    ProfileUi(
        ...
        onAddProfile = {
            context.startActivity(
                android.content.Intent(context, com.teamantigravity.gravityinstaller.presentation.setting.profile.edit.ProfileEditActivity::class.java)
            )
        },
        onEditProfile = { profile ->
            context.startActivity(
                android.content.Intent(context, com.teamantigravity.gravityinstaller.presentation.setting.profile.edit.ProfileEditActivity::class.java).apply {
                    putExtra(com.teamantigravity.gravityinstaller.presentation.setting.profile.edit.ProfileEditActivity.EXTRA_PROFILE_ID, profile.id)
                }
            )
        },
