...
import com.teamantigravity.gravityinstaller.ui.theme.Spacing
    ...
    Column(
        ...
        if (onSkipParse != null) {
            ...
            androidx.compose.material3.TextButton(onClick = onSkipParse) {
                androidx.compose.material3.Text(androidx.compose.ui.res.stringResource(com.teamantigravity.gravityinstaller.R.string.dialog_menu_skip_analysis, "Skip & Install"))
            }
        }
    }
}
