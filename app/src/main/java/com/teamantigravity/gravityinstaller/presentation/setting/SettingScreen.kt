...
import com.teamantigravity.gravityinstaller.presentation.composable.EmptyStateView
import com.teamantigravity.gravityinstaller.presentation.composable.SettingsSection
import com.teamantigravity.gravityinstaller.presentation.composable.UniversalSearchBar
import com.teamantigravity.gravityinstaller.presentation.install.controller.RootState
import com.teamantigravity.gravityinstaller.presentation.setting.profile.PackageNamePickerDialog
import androidx.datastore.preferences.core.Preferences
import org.koin.androidx.compose.koinViewModel
import com.teamantigravity.gravityinstaller.billing.BillingManager
...
fun SettingScreen(
    ...
    SettingUi(
        ...
        onLanguageClick = {
            context.startActivity(android.content.Intent(context, com.teamantigravity.gravityinstaller.presentation.setting.language.LanguageActivity::class.java))
        },
        ...
        onProfilesClick = {
            context.startActivity(android.content.Intent(context, com.teamantigravity.gravityinstaller.presentation.setting.profile.ProfileActivity::class.java))
        },
                        ...
                        SearchableItem(q, stringResource(R.string.theme_screen_title), "interface theme") {
                            ListItem(
                                ...
                                modifier = Modifier.clickable {
                                    context.startActivity(android.content.Intent(context, com.teamantigravity.gravityinstaller.presentation.setting.theme.ThemeActivity::class.java))
                                },
                                colors = ListItemDefaults.colors(containerColor = Color.Transparent)
                            )
                        }
                ...
                if (matchesQuery(q, aboutLabels)) item {
                    SettingsSection(title = stringResource(R.string.setting_section_about), icon = Icons.Rounded.Info) {
                        ListItem(
                            ...
                            modifier = Modifier.clickable {
                                context.startActivity(android.content.Intent(context, com.teamantigravity.gravityinstaller.presentation.setting.about.AboutActivity::class.java))
                            },
                            colors = ListItemDefaults.colors(containerColor = Color.Transparent)
                        )
                        ListItem(
                            ...
                            modifier = Modifier.clickable {
                                context.startActivity(android.content.Intent(context, com.teamantigravity.gravityinstaller.presentation.setting.diagnostics.DiagnosticsActivity::class.java))
                            },
                            colors = ListItemDefaults.colors(containerColor = Color.Transparent)
                        )
                    }
