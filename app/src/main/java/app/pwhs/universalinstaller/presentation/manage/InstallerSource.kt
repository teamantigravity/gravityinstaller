...
fun resolveInstallerInfo(installerPackage: String?, packageName: String): InstallerInfo? {
    return when (installerPackage) {
        ...
        "app.pwhs.universalinstaller" -> InstallerInfo(displayName = "Gravity Installer")
        "app.pwhs.universalinstaller.debug" -> InstallerInfo(displayName = "Gravity Installer (Debug)")
